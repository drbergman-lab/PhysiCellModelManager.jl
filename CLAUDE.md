...
- `ext/` — Julia 1.9+ package extensions
- `test/` — Test suite
- `docs/` — Documentation
...
- **Types / Structs:** `PascalCase` (e.g., `InputFolders`, `DiscreteVariation`)
...
- **Test sets:** match the test file name (e.g., `@testset "MovieTests.jl"`)
