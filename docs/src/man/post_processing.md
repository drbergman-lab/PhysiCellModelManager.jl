...
The population summary statistics have `QoI`-returning builders too — [`populationCountQoI`](@ref) and [`endpointPopulationFractionQoI`](@ref) — which work here as well as in calibration and sensitivity analysis. See [QoI form](@ref qoi_form_ss).
