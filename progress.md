...
- **Figures.** `docs/generate_figures.jl` now also runs a MOAT(8), Sobolʼ(16) and RBD(16) design and
  a four-generation ABC-SMC on the template project -- two parameters, a cycle phase duration and
  ...
  `calibration.md`. The template project rather than `immune_sample`: its config parameters govern
