...
See the [PhysiCellECMCreator.jl](https://github.com/drbergman-lab/PhysiCellECMCreator.jl) documentation for more information on IC ECM and how this function works outside of PhysiCellModelManager.
